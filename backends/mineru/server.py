"""
Mineru Backend Server

Flask server implementation for Mineru backend using the OCRBackend interface.
This server runs on port 5001 and uses GPU 1 exclusively.
"""
...
if __name__ == '__main__':
    ...
    backend = MineruBackend(model_path=model_path)

    if backend.load_model():
        print("✓ Mineru backend initialized successfully")
    else:
        print("✗ Failed to initialize Mineru backend")
